System.config({
  ...
  bundles: {
    "dist/dev/main.js": [
      ...
      "npm:angular2@2.0.0-alpha.44/router",
      ...
      "src/services/name_list.ts",
      "npm:angular2@2.0.0-alpha.44/src/router/router",
      "npm:angular2@2.0.0-alpha.44/src/router/router_outlet",
      "npm:angular2@2.0.0-alpha.44/src/router/router_link",
      "npm:angular2@2.0.0-alpha.44/src/router/instruction",
      "npm:angular2@2.0.0-alpha.44/src/router/route_registry",
      "npm:angular2@2.0.0-alpha.44/src/router/location_strategy",
      "npm:angular2@2.0.0-alpha.44/src/router/hash_location_strategy",
      "npm:angular2@2.0.0-alpha.44/src/router/path_location_strategy",
      "npm:angular2@2.0.0-alpha.44/src/router/location",
      "npm:angular2@2.0.0-alpha.44/src/router/route_config_decorator",
      "npm:angular2@2.0.0-alpha.44/src/router/route_definition",
      "npm:angular2@2.0.0-alpha.44/src/router/lifecycle_annotations",
      "npm:angular2@2.0.0-alpha.44/src/router/route_data",
      ...
      "npm:angular2@2.0.0-alpha.44/src/router/route_lifecycle_reflector",
      "npm:angular2@2.0.0-alpha.44/src/router/route_recognizer",
      "npm:angular2@2.0.0-alpha.44/src/router/route_config_impl",
      "npm:angular2@2.0.0-alpha.44/src/core/reflection/reflection",
      "npm:angular2@2.0.0-alpha.44/src/router/route_config_nomalizer",
      "npm:angular2@2.0.0-alpha.44/src/router/url_parser",
      "npm:angular2@2.0.0-alpha.44/src/core/dom/dom_adapter",
      "npm:angular2@2.0.0-alpha.44/src/core/util/decorators",
      "npm:angular2@2.0.0-alpha.44/src/router/lifecycle_annotations_impl",
      ...
      "npm:angular2@2.0.0-alpha.44/src/router/path_recognizer",
      "npm:angular2@2.0.0-alpha.44/src/router/async_route_handler",
      "npm:angular2@2.0.0-alpha.44/src/router/sync_route_handler",
